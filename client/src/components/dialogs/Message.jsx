...
const Message = (props) => {
  ...
  let [newMessage = '', setMessage] = useState(state.chats[0].message)
  ...
  let messageElement = state.chats.map( (m) => <WroteMessage mess = {m.message} key = {m.id} />)
  return (
    <div className="min-h-full flex flex-col">
      ...
      <div className="dark:text-white flex-auto transition duration-1000 ">
        <div className='ml-24 bg-gray-200 w-1/3 my-4 p-2 rounded-lg dark:bg-black'>message from friend</div>
